...
import turtle
import os
ZLOS=input('ZLOS v1.2a-DE | 1.Rechner 2.Zufälliger Zahlengenerator 3.Zufallszahl erraten 4.Uhr 5.exit')
if ZLOS==str(1):
    root = tkinter.Tk()
    ...
    if __name__ == '__main__':
            Demo()
if ZLOS==str(2):
    min1=int(input('Bitte geben Sie einen Minimalwert ein:'))
    max1=int(input('Bitte geben Sie den maximalen Wert ein:'))
...
if ZLOS==str(3):
    ...
    cs1=int(input('Bitte geben Sie eine Nummer von 1 bis 100 ein:'))
    while s1!=cs1:
        if s1>cs1:
            print('Die von Ihnen eingegebene Nummer'+ str(i)+'ist weniger als eine Zufallszahl')
            cs1=int(input('Versuchs noch mal:'))
        else:
            print('Die Zahl, die Sie für die Zeit'+str(i)+'eingegeben haben, ist größer als die Zufallszahl')
            cs1=int(input('Versuchs noch mal:'))
        i+=1
    print('Glückwunsch! die Zahl die Sie für die'+str(i)+'Zeit eingegeben haben,ist die gleiche wie die Zufallszahl!')
    time.sleep(30)
if ZLOS==str(4):
    while True:
