...
import turtle
import os
ZLOS=input('ZLOS v1.2a-EN | 1.Calculator 2.Random number generator 3.Guess random number 4.Clock 5.exit')
if ZLOS==str(1):
    root = tkinter.Tk()
    ...
    if __name__ == '__main__':
            Demo()
if ZLOS==str(2):
    min1=int(input('Please enter a minimum value:'))
    max1=int(input('Please enter a maximum value:'))
...
if ZLOS==str(3):
    ...
    cs1=int(input('Please enter a number from 1 to 100:'))
    while s1!=cs1:
        if s1>cs1:
            print('The number you entered'+str(i)+' is less than a random number')
            cs1=int(input('Try again:'))
        else:
            print('The number you entered'+str(i)+' is greater than a random number')
            cs1=int(input('Try again:'))
        i+=1
    print('Congratulations! the number you entered for the '+str(i)+'time is the same as the random number!')
    time.sleep(30)
if ZLOS==str(4):
    while True:
